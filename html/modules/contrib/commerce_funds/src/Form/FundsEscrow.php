...
class FundsEscrow extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $fees_description = $this->feesManager->printTransactionFees('escrow');
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($currency_balance < $fee_applied['net_amount']) {
      if (!$fee_applied['fee']) {
        $form_state->setErrorByName('amount', $this->t("Not enough funds to cover this escrow."));
      }
      if ($fee_applied['fee']) {
        $form_state->setErrorByName('amount', $this->t("Not enough funds to cover this escrow (Total: %total @currency).", [
